                                ...
                                <div key={index} className="group relative">
                                    <div className="position-relative overflow-hidden" style={{ paddingBottom: "75%" }}>
                                        <img
                                            ...
                                            alt={category.title}
                                            className="position-absolute top-0 start-0 w-100 h-100 object-fit-cover filter grayscale transition group-hover:grayscale-0 transition-all duration-300"
                                        />
                                        <div className="position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-50 d-flex flex-column align-items-center justify-content-center text-white opacity-0 group-hover:opacity-100 transition-opacity">
                                            <h3 className="h4 fw-bold mb-2">{category.title}</h3>
                                            {/* <p className="small mb-3">{category.description}</p> */}
                                            <button className="btn btn-light text-dark px-4 py-2 fw-bold rounded-0">Shop Now</button>
                                        </div>
                                    </div>
                                </div>
